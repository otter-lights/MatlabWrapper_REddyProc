...
#then set the time (dataframe, original time format, name of year col, name of day col, name of hour col)
...
#TimeZoneHour is the hours shift to UTC, -5 for Ottawa Area
...
#Do partitioning based on the Ustar scenarios, using the night time method
